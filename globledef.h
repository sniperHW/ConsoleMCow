...
const std::vector<std::string>GameTypeName{"Max6_NL50_SD150","Max6_NL50_SD100","Max6_NL50_SD75","Max6_NL50_SD50","Max6_NL50_SD20",""};
...
typedef enum { Max6_NL50_SD150, Max6_NL50_SD100, Max6_NL50_SD75, Max6_NL50_SD50, Max6_NL50_SD20, GAMETYPE_none}GameType; //SD为筹码深度，每个筹码深度相关配置和数据都独立
const std::array<GameType, 5>GameTypes{ Max6_NL50_SD150, Max6_NL50_SD100, Max6_NL50_SD75, Max6_NL50_SD50, Max6_NL50_SD20 };
