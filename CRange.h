...
public:
	...
	bool Load(GameType gmType, const Json::Value & root, const std::string & sActionSquence, const Stacks& stacks, const std::string& sBoardNext, const SuitReplace& suitReplace); //solver模式，同构转换，排除公牌
