...
public:
	...
	bool Load(GameType gmType, const std::string & sActionSquence, const StackByStrategy& stack, const std::string& sBoardNext, const SuitReplace& suitReplace, const std::string& sIsoBoard); //wizard模式，同构转换，排除公牌
